  ...
  return (
    <div className="-mt-16">
      ...
      <div className="mx-auto max-w-7xl">
        <Row title="Airing Today" items={airing.results} forceType="tv" />
        <Row title="Popular" items={popular.results} forceType="tv" />
        <Row title="Top Rated" items={topRated.results} forceType="tv" />
      </div>
    </div>
  );
}
